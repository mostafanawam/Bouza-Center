	...
	.im
{
      ...
      <?php
	   ...
	   $dir="gallery";
        ...
        while($f = readdir($d))
		{
          //We accept only the jpg images
          $a = explode('.', $f);
          //image.1.2.3.jpg: the extension is in the last case
          if(strtolower($a[count($a) - 1]) == 'jpg')
		  {
            $counter++;
			 if(($counter % 3) ==1)
				 echo "<tr>";
               ...
               echo"<td>
						<a class='lightbox' href='$dir/$f'>
							<img  src='$dir/$f' alt='Gallery Images'>
						</a>
					</td>";
