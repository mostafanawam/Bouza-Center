	...
	<footer class="footer-area bg-f">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					...
					<p class="lead">Lebanon,Old Saida</p>
					<p class="lead"><a href="#">+961 07752122</a></p>
					<p><a href="#"> HadayaBouza.com</a></p>
				</div>
				<div class="col-lg-3 col-md-6">
					<h3>Subscribe</h3>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<p class="company-name">All Rights Reserved. &copy; 2020 <a href="#">Bouza Hadaya</a> Design By :
					<a href="https://html.design/">Mostafa Nawam</a></p>
					</div>
				</div>
			</div>
		</div>
